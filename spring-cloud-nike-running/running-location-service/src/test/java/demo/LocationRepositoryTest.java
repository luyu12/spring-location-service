...
public class LocationRepositoryTest {
    ...
    {
        this.repository.save(new location(new UnitInfo("YULU-runningId-1")));

        assertThat(this.repository.findByUnitInfoRunningId("YULU-runningId-1",new PageRequest(0,1)).getContent().get(0).getRunningId()).isEqualTo("YULU-runningId-1");
    }
    @Test
    public void whenQueryInfoRunningId_expectOk()
    {
        final String runningId="yulu-runningId-2";
