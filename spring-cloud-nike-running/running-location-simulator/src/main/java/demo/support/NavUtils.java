...
public class NavUtils {
    ...
    public static double getDistance(Point point1,Point point2){
        ...
        return DistanceUtils.degrees2Dist(ctx.getDistCalc().distance(p1,p2),DistanceUtils.EARTH_MEAN_RADIUS_KM);
    ...
    public static Point getPosition(Point pt1, double d, double brg){
        ...
        double lon2=lon1+Math.atan2(x,y);//注意这里计算出来的新的destination point的lat和long全部都是弧度制
